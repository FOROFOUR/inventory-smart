...
$conn = getDBConnection(); // ← config.php uses a function, so we call it here
...
// ── Stats ──────────────────────────────────────────────────────────────────
$stats = [];
$statuses = ['PENDING', 'RELEASED', 'RETURNED', 'CANCELLED'];
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* ── SIDEBAR (matches warehouse_sidebar.php) ── */
  /* Include your warehouse_sidebar.php here */

  /* ── MAIN CONTENT ── */
.main-content { position: relative; left: 250px; width: calc(100% - 250px); }
.sidebar.close ~ .main-content { left: 88px; width: calc(100% - 88px); }
  ...
  .stat-card.pending  .stat-icon { background: #fef9ed; color: var(--pending); }
  ...
  .stat-card.pending  .count { color: var(--pending); }
  ...
  .summary-card .info .val {
    font-size: 1.5rem;
    font-weight: 700;
    color: var(--text);
  }

  .summary-card .info .desc {
    font-size: .78rem;
    color: var(--text-muted);
  }
  ...
  .badge-pending  { background: #fef9ed; color: #d68910; }
...
<div class="main-content" id="mainContent">
  ...
  <div class="page-header">
    <div>
      ...
      <span>Welcome back, <?= htmlspecialchars($user_name) ?>! Here's your overview.</span>
    </div>
  ...
  <div class="summary-row">
    <div class="summary-card">
      ...
      <div class="info">
        ...
        <div class="desc">Total Pull-Out Transactions (All Time)</div>
      </div>
    </div>
    <div class="summary-card">
  ...
  <div class="content-row">
    ...
    <div class="card">
      <div class="card-header">
        <h3><i class='bx bx-transfer' style="color:var(--amber); margin-right:6px;"></i>Recent Pull-Out Transactions</h3>
            ...
            <tr>
              ...
              <td>
                <?php
                  ...
                  $labels = ['pending'=>'Pending','released'=>'Released','returned'=>'Returned','cancelled'=>'Cancelled'];
                ?>
...
<script>
  // Sync sidebar collapse state with main content
