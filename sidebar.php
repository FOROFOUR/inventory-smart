...
<style>
    ...
    .sidebar.close .nav-link .badge {
        ...
        margin-left: 0; min-width: 17px; height: 17px;
    ...
    .nav-link .badge-tooltip::before {
        ...
        border: 5px solid transparent; border-right-color: #1a1a2e;
    }
    ...
    .notif-bell-btn:hover { box-shadow: 0 4px 18px rgba(0,0,0,.18); }
    .notif-bell-btn i { font-size: 1.35rem; color: #2c3e50; }
    ...
    .notif-header {
        padding: .9rem 1.2rem; border-bottom: 1px solid #f0f3f6;
        display: flex; justify-content: space-between; align-items: center;
    }
    .notif-header span { font-size: .9rem; font-weight: 700; color: #2c3e50; font-family: 'Poppins', sans-serif; }
    .notif-mark-read {
        font-size: .74rem; color: #f39c12; font-weight: 600;
    ...
    .notif-item {
        ...
        padding: .85rem 1.2rem; border-bottom: 1px solid #f8f9fa;
    ...
    .notif-body .ndesc {
        font-size: .76rem; color: #7f8c8d; margin-top: 2px;
        line-height: 1.4; font-family: 'Poppins', sans-serif;
        display: -webkit-box; -webkit-line-clamp: 2;
        -webkit-box-orient: vertical; overflow: hidden;
    }
    .notif-body .ntime {
        font-size: .7rem; color: #bdc3c7; margin-top: 3px;
        font-family: 'Poppins', sans-serif;
    }
    .notif-empty {
        padding: 2.5rem; text-align: center; color: #bdc3c7;
    }
    .notif-empty i { font-size: 2.2rem; display: block; margin-bottom: .5rem; }
    .notif-empty span { font-size: .82rem; font-family: 'Poppins', sans-serif; }

    .notif-footer {
        padding: .75rem 1.2rem; border-top: 1px solid #f0f3f6;
        text-align: center;
    }
    .notif-footer a {
        font-size: .78rem; color: #f39c12; font-weight: 600;
    ...
    .notif-summary {
        display: flex; gap: .5rem; padding: .75rem 1.2rem;
        border-bottom: 1px solid #f0f3f6; flex-wrap: wrap;
    }
    .npill {
        display: inline-flex; align-items: center; gap: .3rem;
        padding: .25rem .65rem; border-radius: 20px;
        font-size: .74rem; font-weight: 600; font-family: 'Poppins', sans-serif;
    }
...
<nav class="sidebar">
    <header>
        <div class="image-text">
            <span class="image"><i class='bx bxs-box'></i></span>
