    ...
    <style>
      :root {
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Space Grotesk', sans-serif; }
        ...
        .prep-card:hover { transform: translateY(-4px); box-shadow: 0 10px 25px rgba(0,0,0,.12); }
        ...
        .step-node.active { border-color: var(--purple); background: white; color: var(--purple); box-shadow: 0 0 0 3px rgba(142,68,173,.2); }
        ...
        @media (max-width: 768px) {
            ...
            .prep-card { padding: 1.1rem; }
            .step-track { gap: 6px; }
            .step-node { width: 30px; height: 30px; font-size: .8rem; }
        }

        @media (max-width: 480px) {
            .prep-meta { grid-template-columns: 1fr; }
        }
